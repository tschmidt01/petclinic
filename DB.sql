...
CREATE INDEX idx_owners_address_trgm ON public.owners USING gin (lower(address) public.gin_trgm_ops);

CREATE INDEX idx_owners_city_trgm ON public.owners USING gin (lower(city) public.gin_trgm_ops);

CREATE INDEX idx_owners_first_name_trgm ON public.owners USING gin (lower(first_name) public.gin_trgm_ops);

CREATE INDEX idx_owners_last_name_trgm ON public.owners USING gin (lower(last_name) public.gin_trgm_ops);

CREATE INDEX idx_owners_telephone_trgm ON public.owners USING gin (lower(telephone) public.gin_trgm_ops);

CREATE INDEX idx_pets_name_trgm ON public.pets USING gin (lower(name) public.gin_trgm_ops);
