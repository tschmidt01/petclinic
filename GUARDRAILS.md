...
| `C3ArchTest` | C4 architecture drift | Parses hand-written `docs/c4model.dsl`; asserts every code package is mapped to a component and component-to-component dependencies match the code; re-exports `*.puml` views |
